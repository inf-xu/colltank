...
import '../../core/preferences/repositories/preferences_repository.dart';
...
import '../../core/preferences/usecases/update_import_mode_usecase.dart';
import '../../core/preferences/usecases/update_root_directory_usecase.dart';
...
final collectiblesRepositoryProvider = Provider<CollectiblesRepository>((ref) {
  final dao = ref.watch(appDatabaseProvider).collectiblesDao;
  return CollectiblesRepository(dao);
});

final highlightSlotsRepositoryProvider = Provider<HighlightSlotsRepository>((
  ref,
) {
...
final reorderCollectionsUsecaseProvider = Provider<ReorderCollectionsUsecase>((
  ref,
) {
  return ReorderCollectionsUsecase(ref.watch(collectionsRepositoryProvider));
});

final switchFrameStyleUsecaseProvider = Provider<SwitchFrameStyleUsecase>((
  ref,
) {
  return SwitchFrameStyleUsecase(ref.watch(collectionsRepositoryProvider));
});

final updateCoverPreviewUsecaseProvider = Provider<UpdateCoverPreviewUsecase>((
  ref,
) {
  return UpdateCoverPreviewUsecase(ref.watch(collectionsRepositoryProvider));
});
...
final addCollectibleUsecaseProvider = Provider<AddCollectibleUsecase>((ref) {
...
final assignHighlightSlotUsecaseProvider = Provider<AssignHighlightSlotUsecase>(
  (ref) {
...
final resetHighlightSlotsUsecaseProvider = Provider<ResetHighlightSlotsUsecase>(
  (ref) {
...
final updateImportModeUsecaseProvider = Provider<UpdateImportModeUsecase>((
  ref,
) {
  return UpdateImportModeUsecase(ref.watch(preferencesRepositoryProvider));
});

final updateRootDirectoryUsecaseProvider = Provider<UpdateRootDirectoryUsecase>(
  (ref) {
    return UpdateRootDirectoryUsecase(ref.watch(preferencesRepositoryProvider));
  },
);
